...
{'name': 'RoutingContext.getBodyAsJsonArray', 'type': 'function', 'url': 'RoutingContext.type.html#getBodyAsJsonArray', 'doc': '<p>@return Get the entire HTTP request body as a .</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'BridgeEvent.getRawMessage', 'type': 'function', 'url': 'handler/sockjs/BridgeEvent.type.html#getRawMessage', 'doc': '<p>Get the raw JSON message for the event.</p>', 'tags': [],'icons': ['icon-shared-member']},
